...
\end{align*}
once per simulation. This is a typical data-generating process for data with a
binary outcome and typically assumed in models for (high-dimensional) genetic
