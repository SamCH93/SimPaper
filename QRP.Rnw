...
\begin{table}[!htb]
  ...
  \centering
    ...
    \midrule
    \begin{itemize}
      \item Use simulation protocols
      \item Collaboration between different research groups (with possibly
            ``competing'' methods)
      \item Blinded analyses of simulation results
      \item Distinguish exploratory from confirmatory findings
    \end{itemize}
    \\[1em]
    ...
    \begin{itemize}
      \item Provide incentives for rigorous simulation studies (\eg badges on
            paper)
      \item Require/demand (preregistered) simulation protocols
    ...
    \midrule
    \begin{itemize}
      \item Adopt reporting guidelines
      \item Promote/fund methodology and software to facilitate sound design,
