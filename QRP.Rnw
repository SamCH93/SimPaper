...
promoted as improvement. While simulations protocols may at first seem as a
disadvantage due to additional work and lower possibility of publication, they
also provide researchers a means to think harder about setting up a good
simulation study, and thus differentiate themselves from unregistered
simulations.
...
are set in place. This approach also helps making post hoc modifications of the
simulation study more legitimate. Finally, it is important for researchers to
separate exploratory from confirmatory findings in the reporting of their
simulation studies. By clearly indicating exploratory findings, overoptimism can
be avoided and lead to a more realistic picture.
...
By using a wide range of simulation study QRPs we were able to present a flawed
method as an improvement over comparators. We hope that our illustration will
increase the awareness about the fragility of findings from simulation studies,
