...
\paragraph{Switchting the primary estimand (D4)}
...
\paragraph{Removing comparators (D3)}
...
\paragraph{Altering the scope of the simulation study (D1)}
...
\paragraph{Handling exceptions differently (D5)}
