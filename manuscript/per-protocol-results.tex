...
\begin{figure}[!ht]
\center
\includegraphics[width=0.9\linewidth]{figures-appendix/figures-results/tie-fighter_brier.pdf}
...
\begin{figure}[!ht]
\center
\includegraphics[width=0.9\linewidth]{figures-appendix/figures-results/tie-fighter_scaledBrier.pdf}
...
\begin{figure}[!ht]
\center
\includegraphics[width=0.9\linewidth]{figures-appendix/figures-results/tie-fighter_nll.pdf}
...
\begin{figure}[!ht]
\center
\includegraphics[width=0.9\linewidth]{figures-appendix/figures-results/calibration-cslope.pdf}
...
\begin{figure}[!ht]
\center
\includegraphics[width=0.9\linewidth]{figures-appendix/figures-results/calibration-clarge.pdf}
